...
<svg {style} viewBox="0 0 1024 1024" xmlns="http://www.w3.org/2000/svg">
  <path
    ...
    fill="currentColor"
  />
  <path d="M288 672h320q32 0 32 32t-32 32H288q-32 0-32-32t32-32z" fill="currentColor" />
  <path
  ...
  <path
    ...
    fill="currentColor"
  />
  <path d="m373.376 599.808-42.752-47.616 320-288 42.752 47.616z" fill="currentColor" />
</svg>
